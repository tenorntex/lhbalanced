...
@	compiled by GNU C version 4.6.x-google 20120106 (prerelease), GMP version 4.2.4, MPFR version 2.4.1.
@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed:  -nostdinc -I/usr/src/dell/lhbalanced/arch/arm/include
@ -Iinclude -Iarch/arm/mach-msm/include -imultilib armv7-a -iprefix
@ /usr/src/dell/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/../lib/gcc/arm-linux-androideabi/4.4.3/
@ -D__KERNEL__ -D__LINUX_ARM_ARCH__=7 -Uarm -DKBUILD_STR(s)=#s
@ -DKBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -DKBUILD_MODNAME=KBUILD_STR(asm_offsets) -isystem
@ /usr/src/dell/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/../lib/gcc/arm-linux-androideabi/4.4.3/include
@ -include include/generated/autoconf.h -MD
@ arch/arm/kernel/.asm-offsets.s.d arch/arm/kernel/asm-offsets.c -mbionic
@ -fpic -mlittle-endian -mfpu=neon -march=armv7-a -marm -mabi=aapcs-linux
...
@ Compiler executable checksum: 875ddd3d018825a918dcfcbcd5d52f27
...
->TSK_ACTIVE_MM #200 offsetof(struct task_struct, active_mm)	@
@ 0 "" 2
